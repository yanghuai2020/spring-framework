...
public class BeanValidationPostProcessorTests {
	...
	public void testNotNullConstraint() {
		...
		assertThatExceptionOfType(BeanCreationException.class).isThrownBy(ac::refresh).havingRootCause().withMessageContainingAll("testBean", "invalid");
		ac.close();
	}
	...
	public void testSizeConstraint() {
		...
		ac.registerBeanDefinition("bean", bd);
		assertThatExceptionOfType(BeanCreationException.class).isThrownBy(() -> ac.refresh()).havingRootCause().withMessageContainingAll("stringValue", "invalid");
		ac.close();
	}
