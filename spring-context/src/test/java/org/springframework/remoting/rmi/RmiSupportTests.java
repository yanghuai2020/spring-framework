...
public class RmiSupportTests {
	...
	public void rmiProxyFactoryBeanWithWrongBusinessInterface() throws Exception {
		...
		boolean condition1 = proxy instanceof IRemoteBean;
		assertThat(condition1).isFalse();
		assertThatExceptionOfType(RemoteProxyFailureException.class).isThrownBy(() -> proxy.setOtherName("name")).withCauseInstanceOf(NoSuchMethodException.class).withMessageContaining("setOtherName").withMessageContaining("IWrongBusinessBean");
		assertThat(factory.counter).isEqualTo(1);
	}
	...
	private void doTestRmiProxyFactoryBeanWithBusinessInterfaceAndException(Class<?> rmiExceptionClass, Class<? extends Throwable> springExceptionClass) throws Exception {
	...
	private void doTestRmiProxyFactoryBeanWithBusinessInterfaceAndExceptionAndRefresh(Class<?> rmiExceptionClass, Class<? extends Throwable> springExceptionClass) throws Exception {
