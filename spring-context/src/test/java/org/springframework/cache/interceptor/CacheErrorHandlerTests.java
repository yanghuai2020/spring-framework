...
public class CacheErrorHandlerTests {
	...
	public void getFailProperException() {
		...
		assertThatExceptionOfType(UnsupportedOperationException.class).isThrownBy(() -> this.simpleService.get(0L)).withMessage("Test exception on get");
	}
	...
	public void putFailProperException() {
		...
		assertThatExceptionOfType(UnsupportedOperationException.class).isThrownBy(() -> this.simpleService.put(0L)).withMessage("Test exception on put");
	}
	...
	public void evictFailProperException() {
		...
		assertThatExceptionOfType(UnsupportedOperationException.class).isThrownBy(() -> this.simpleService.evict(0L)).withMessage("Test exception on evict");
	}
	...
	public void clearFailProperException() {
		...
		assertThatExceptionOfType(UnsupportedOperationException.class).isThrownBy(() -> this.simpleService.clear()).withMessage("Test exception on clear");
	}
