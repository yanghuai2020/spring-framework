...
public class TestDynamicMBean implements DynamicMBean {
	...
	public MBeanInfo getMBeanInfo() {
		...
		return new MBeanInfo(TestDynamicMBean.class.getName(), "", new MBeanAttributeInfo[]{attr}, new MBeanConstructorInfo[0], new MBeanOperationInfo[0], new MBeanNotificationInfo[0]);
	}
