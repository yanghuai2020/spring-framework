...
public class TigerAspectJExpressionPointcutTests {
	...
	public void testMatchVarargs() throws Exception {
		...
		assertThat(jdbcVarArgs.matches(MyTemplate.class.getMethod("queryForInt", String.class, Object[].class), MyTemplate.class)).isTrue();
	...
	public void testAnnotationOnMethodWithWildcard() throws Exception {
		...
		assertThat(anySpringMethodAnnotation.matches(HasTransactionalAnnotation.class.getMethod("foo"), HasTransactionalAnnotation.class)).isFalse();
		assertThat(anySpringMethodAnnotation.matches(HasTransactionalAnnotation.class.getMethod("bar", String.class), HasTransactionalAnnotation.class)).isFalse();
	...
	public void testAnnotationOnMethodArgumentsWithFQN() throws Exception {
		...
		assertThat(takesSpringAnnotatedArgument2.matches(ProcessesSpringAnnotatedParameters.class.getMethod("takesNoAnnotatedParameters", TestBean.class, BeanA.class), ProcessesSpringAnnotatedParameters.class, new TestBean(), new BeanA())).isFalse();
	}
	...
	public void testAnnotationOnMethodArgumentsWithWildcards() throws Exception {
		...
		assertThat(takesSpringAnnotatedArgument2.matches(ProcessesSpringAnnotatedParameters.class.getMethod("takesAnnotatedParameters", TestBean.class, SpringAnnotated.class), ProcessesSpringAnnotatedParameters.class)).isTrue();
		assertThat(takesSpringAnnotatedArgument2.matches(ProcessesSpringAnnotatedParameters.class.getMethod("takesNoAnnotatedParameters", TestBean.class, BeanA.class), ProcessesSpringAnnotatedParameters.class)).isFalse();
	}
