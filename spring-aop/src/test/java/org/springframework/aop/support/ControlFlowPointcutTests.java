...
public class ControlFlowPointcutTests {
	...
	public void testToString() {
		assertThat(new ControlFlowPointcut(One.class).toString()).isEqualTo(ControlFlowPointcut.class.getName() + ": class = " + One.class.getName() + "; methodName = null");
		assertThat(new ControlFlowPointcut(One.class, "getAge").toString()).isEqualTo(ControlFlowPointcut.class.getName() + ": class = " + One.class.getName() + "; methodName = getAge");
	}
